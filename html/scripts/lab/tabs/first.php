            ...
            <div class="section-top-border">
                <div class="row d-flex justify-content-center">
                    ...
                    <p class="col-lg-9 col-md-9 col-sm-10">
                        <?php echo replace_text($pairs, $user_information["story1"])."\n"; ?>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div classv class="section-top-border">
                <div class="row d-flex justify-content-center">
                    ...
                    <p class="col-lg-9 col-md-9 col-sm-10">
                        <?php
                        $sql = 'SELECT * FROM timeline WHERE murder=1 AND person="'.$user_information["username"].'" ORDER BY hour ASC, minute ASC';
                        $result = $conn->query($sql);
                        while ($row = $result->fetch_assoc()) {
                            $minute = $row["minute"];
    ...
    <section id="admit1">
        <div class="container">
            <div classv class="section-top-border">
                <div class="row d-flex justify-content-center">
                    <h2 class="col-lg-9 col-md-9 col-sm-10">被问及必须承认的事情：</h2>
                    <br><br><br>
                    <ul class="col-lg-8 col-md-9 col-sm-10 unordered-list">
                        <?php
                        $sql = 'SELECT * FROM admit WHERE person="'.$user_information["username"].'" ORDER BY id ASC';
                        $result = $conn->query($sql);
                        while ($row = $result->fetch_assoc()) {
        ...
        <div class="container">
            <div classv class="section-top-border">
                <div class="row d-flex justify-content-center">
                    ...
                    <br><br><br>
                    <?php
                    $sql = 'SELECT id, position, content1 FROM clues WHERE murder=1 AND location="'.$_SESSION["username"].'" ORDER BY id ASC';
                    $result = $conn->query($sql);
                    while($row = $result->fetch_assoc()) {
                        echo '
                    <div style="cursor: pointer;" class="col-lg-5 col-md-5 col-sm-10" onclick="open_modal('.(file_exists("files/clues/".$row["id"].".jpg")? $row["id"]:0).', \''.replace_text($pairs, $row["position"]).'\', \''.$row["content1"].'\')">
                        <div class="single-offer d-flex flex-row pb-30">
                            ...
                            if (!file_exists("files/clues/".$row["id"].".jpg")) {
                                ...
                                echo '
                                <img style="width: 95px; height: 80px;" src="files/clues/'.$row["id"].'.jpg">';
                            }
                            echo '
                            </div>
                            <div class="desc">
    ...
    <section id="skill1">
        <div class="container">
            <div class="section-top-border">
                <div class="row d-flex justify-content-center">
                    <h2 class="col-lg-9 col-md-9 col-sm-10">你的特殊技能：</h2>
                    <br><br><br>
                    <p class="col-lg-9 col-md-9 col-sm-10">
                        <?php
                        $sql = 'SELECT content FROM skills WHERE id='.$user_information["skill"];
                        $result = $conn->query($sql);
                        while ($row = $result->fetch_assoc()) {
                            echo $row["content"];
                        }
