...
if (isset($_SESSION["username"])) {
    header("Location: home.php?tab=first");
}
?>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7 col-sm-9 col-11">
                    <form action="index.php" method="post">
                        <div class="mt-10">
                            <input autofocus type="text" name="username" required placeholder="用户名" onfocus="this.placeholder=''" onblur="this.placeholder='用户名'" class="single-input" value="<?php echo (isset($_GET["username"])? $_GET["username"]:"") ?>">
                        </div>
                        <div class="mt-10">
