        ...
        <div class="container">
            <div class="section-top-border">
                <div class="row d-flex justify-content-between">
                    ...
                    <br><br><br>
                    <?php
                    $sql = 'SELECT C.id, L.location_c, C.position, C.content2, C.content3, C.prerequisite FROM player_clue as PC LEFT JOIN clues as C on PC.clue=C.id LEFT JOIN location AS L ON C.location=L.location_e WHERE PC.person="'.$_SESSION["username"].'" ORDER BY time DESC';
        ...
        <div class="modal-content col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1">
            ...
            <div class="modal-footer justify-content-center" style="font-size: 14pt;">
                <form method="get" action="home.php?">
                    ...
                    <button class="genric-btn info circle e-large" name="unlock">确定</button>
                </form>
